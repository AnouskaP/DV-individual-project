document.getElementById("csv-select5").addEventListener("change", function () {
  var selectedCsvFileName = this.value;
  clearChart();

  loadData(selectedCsvFileName);
});

loadData(document.getElementById("csv-select5").value);
